    ...
    return (
        <div className="about">
            ...
            <div className="about-text">
                <p>
                    I am currently pursuing a Computer Engineering degree in the
                    University of South Florida. My knack for gaming as a child
                    gave me a keen eye for details in all things digital. I
                    aspire to pursue a career in software engineering. When I am
                    not developing, I play the guitar, some table tennis and
                    make a cup of hot chocloate.
                </p>
            </div>
            ...
            <div className="about-info">
                ...
                <div className="about-info-section">
                    ...
                    <p className="about-info-section-content">
                        Awarded for having an admission SAT of 1340+ and GPA of
                        3.90+
                    </p>
                    <p className="about-info-section-subheading">
